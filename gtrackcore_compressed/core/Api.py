...
from gtrackcore_compressed.util.profile.Profiler import Profiler
...
def importFile(fileName, genome, trackName):
    ...
    from gtrackcore_compressed.util.CommonFunctions import createOrigPath, createPath
...
def _convertTrackName(trackName):
    ...
    """
    from gtrackcore_compressed.util.CommonFunctions import convertTNstrToTNListFormat
...
def _getDirPath(genome=''):
    ...
    """
    from gtrackcore_compressed.util.CommonFunctions import get_dir_path, createPath
...
def listAvailableTracks(genome):
    ...
    from gtrackcore_compressed.track.hierarchy.ProcTrackNameSource import ProcTrackNameSource
...
def getExtractionOptions(genome, trackName):
    ...
    from gtrackcore_compressed.extract.TrackExtractor import TrackExtractor
...
def getTrackElementCount(trackData):
    from gtrackcore_compressed.track.tools.TrackTools import countElements
