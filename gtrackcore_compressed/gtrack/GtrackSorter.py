...
from gtrackcore_compressed.input.wrappers.GEDependentAttributesHolder import GEDependentAttributesHolder, iterateOverBRTuplesWithContainedGEs
from gtrackcore_compressed.input.wrappers.GESourceWrapper import SortedListGESourceWrapper
