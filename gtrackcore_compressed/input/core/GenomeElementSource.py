...
from gtrackcore_compressed.core.LogSetup import logException
...
from gtrackcore_compressed.util.CommonFunctions import getFileSuffix
from gtrackcore_compressed.util.CommonConstants import BINARY_MISSING_VAL, RESERVED_PREFIXES
from gtrackcore_compressed.util.CustomExceptions import NotSupportedError, InvalidFormatError, \
...
def getAllGenomeElementSourceClasses(forPreProcessor):
    from gtrackcore_compressed.input.fileformats.BedGenomeElementSource import PointBedGenomeElementSource, BedValuedGenomeElementSource, \
                                                                BedCategoryGenomeElementSource, BedGenomeElementSource
    from gtrackcore_compressed.input.fileformats.GffGenomeElementSource import GffCategoryGenomeElementSource, GffGenomeElementSource
    from gtrackcore_compressed.input.fileformats.FastaGenomeElementSource import FastaGenomeElementSource
    from gtrackcore_compressed.input.fileformats.HBFunctionGenomeElementSource import HBFunctionGenomeElementSource
    from gtrackcore_compressed.input.fileformats.BedGraphGenomeElementSource import BedGraphTargetControlGenomeElementSource, BedGraphGenomeElementSource
    from gtrackcore_compressed.input.fileformats.MicroarrayGenomeElementSource import MicroarrayGenomeElementSource
    ...
    if forPreProcessor:
        from gtrackcore_compressed.input.fileformats.WigGenomeElementSource import HbWigGenomeElementSource
        from gtrackcore_compressed.input.fileformats.GtrackGenomeElementSource import HbGzipGtrackGenomeElementSource, HbGtrackGenomeElementSource
        allGESourceClasses += [HbWigGenomeElementSource, HbGzipGtrackGenomeElementSource, HbGtrackGenomeElementSource]
    else:
        from gtrackcore_compressed.input.fileformats.WigGenomeElementSource import WigGenomeElementSource
        from gtrackcore_compressed.input.fileformats.GtrackGenomeElementSource import GzipGtrackGenomeElementSource, GtrackGenomeElementSource
