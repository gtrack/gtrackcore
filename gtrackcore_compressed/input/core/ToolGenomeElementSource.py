...
from gtrackcore_compressed.util.CustomExceptions import InvalidFormatError, NotSupportedError
...
def get_all_genome_element_source_classes():
    from gtrackcore_compressed.input.tools.OverlapToolGenomeElementSource import OverlapToolGenomeElementSource
    from gtrackcore_compressed.input.tools.MeanToolGenomeElementSource import MeanToolGenomeElementSource
    from gtrackcore_compressed.input.tools.UnionToolGenomeElementSource import UnionToolGenomeElementSource
