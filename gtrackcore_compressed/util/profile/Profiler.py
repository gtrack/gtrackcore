...
class Profiler:
    ...
    def printStats(self, graphDir=None, id=None):
        ...
        if graphDir:
            from gtrackcore_compressed.third_party.PstatsUtil import OverheadStats
            import os
...
def profile_operation(operation, track_name1, allow_overlaps1, genome_regions, track_name2=None, allow_overlaps2=None):
    from gtrackcore_compressed.tools.TrackOperations import count_elements, sum_of_values, \
