...
from gtrackcore_compressed.metadata.TrackInfo import DynamicTrackInfo, TrackInfo
from gtrackcore_compressed.preprocess.GESourceManager import GESourceManager, OverlapClusteringGESourceManager, RegionBasedGESourceManager
from gtrackcore_compressed.preprocess.PreProcessGeSourceJob import PreProcessGeSourceJob
from gtrackcore_compressed.preprocess.PreProcMetaDataCollector import PreProcMetaDataCollector
from gtrackcore_compressed.preprocess.PreProcessUtils import PreProcessUtils
from gtrackcore_compressed.track.format.TrackFormat import TrackFormat
from gtrackcore_compressed.track.hierarchy.ExternalTrackManager import ExternalTrackManager
from gtrackcore_compressed.track.hierarchy.ProcTrackOptions import ProcTrackOptions
...
class PreProcessTracksJob(object):
    ...
    def process(self):
        ...
        gtrackcore_compressed.preprocess.is_preprocessing = True
        ...
        gtrackcore_compressed.preprocess.is_preprocessing = False
