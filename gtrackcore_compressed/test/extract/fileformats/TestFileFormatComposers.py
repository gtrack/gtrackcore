...
from gtrackcore_compressed.extract.fileformats.BedGraphComposer import BedGraphComposer
...
from gtrackcore_compressed.input.userbins.UserBinSource import GlobalBinSource
