...
from gtrackcore_compressed.util.CommonFunctions import createOrigPath, get_dir_path, createPath
...
class TestWithGeSourceData(unittest.TestCase):
    ...
    def _commonSetup(self):
        from gtrackcore_compressed.test.input.core.TestGenomeElementSource import TestGenomeElementSource
