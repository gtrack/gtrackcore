...
from gtrackcore_compressed.test.track.common.SampleTrack import SampleTrack
from gtrackcore_compressed.test.track.common.SampleTrackView import SampleTV, SampleTV_Num
...
from gtrackcore_compressed.track.random.PermutedSegsAndIntersegsTrack import PermutedSegsAndIntersegsTrack
from gtrackcore_compressed.track.random.PermutedSegsAndSampledIntersegsTrack import PermutedSegsAndSampledIntersegsTrack
from gtrackcore_compressed.track.random.SegsSampledByIntensityTrack import SegsSampledByIntensityTrack

import gtrackcore_compressed.track.random.SegsSampledByIntensityTrack
...
class TestRandomizedSegsTrack(TestCaseWithImprovedAsserts):
    ...
    def _doRandTest(self, origTV, randTrackClasses):
        ...
        gtrackcore_compressed.track.random.SegsSampledByIntensityTrack.PlainTrack = MyPlainTrack
