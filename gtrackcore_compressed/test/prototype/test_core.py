...
from gtrackcore_compressed.prototype.core import gtrackcore
from gtrackcore_compressed.test.prototype.common import gtrackcoreTest

class CoreTest(gtrackcoreTest):
        
    def test_empty_track(self):
        track = self.get_track()   
        self.assertEquals(5, len(list(track.h5)))
        self.assertFalse(len(track.h5.getNode(gtrackcore.ROOT + gtrackcore.NODES)))
        self.assertFalse(len(track.h5.getNode(gtrackcore.ROOT + gtrackcore.LINKS)))
        self.assertTrue(track.is_valid_gtrackcore(track.h5))
