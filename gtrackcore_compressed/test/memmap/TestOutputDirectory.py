...
import gtrackcore_compressed.preprocess.memmap.OutputDirectory

from gtrackcore_compressed.input.core.GenomeElement import GenomeElement
from gtrackcore_compressed.preprocess.memmap.OutputFile import OutputFile
from gtrackcore_compressed.preprocess.memmap.OutputIndexFilePair import OutputIndexFilePair

from gtrackcore_compressed.test.common.Asserts import TestCaseWithImprovedAsserts
from gtrackcore_compressed.test.common.FileUtils import removeDirectoryTree
...
class SetupDir:
    def __init__(self, path, prefixList):
        ...
        from gtrackcore_compressed.preprocess.memmap.OutputDirectory import OutputDirectory
...
class TestOutputDirectory(TestCaseWithImprovedAsserts):
    ...
    def setUp(self):
        ...
        gtrackcore_compressed.preprocess.memmap.OutputDirectory.OutputFile = MyOutputFile
        gtrackcore_compressed.preprocess.memmap.OutputDirectory.OutputIndexFilePair = MyOutputIndexFilePair
    ...
    def tearDown(self):
        ...
        gtrackcore_compressed.preprocess.memmap.OutputDirectory.OutputFile = OutputFile
        gtrackcore_compressed.preprocess.memmap.OutputDirectory.OutputIndexFilePair = OutputIndexFilePair
        self._removeDirTree()
