...
from gtrackcore_compressed.util.CommonFunctions import getStringFromStrand, parseRegSpec, \
                                        parseTrackNameSpec, get_dir_path, \
                                        createPath
from gtrackcore_compressed.util.CustomExceptions import NotSupportedError, ShouldNotOccurError
...
class TrackExtractor:
    ...
    def getTrackExtractionOptions(genome, trackName):
        from gtrackcore_compressed.track.core.Track import PlainTrack
        from gtrackcore_compressed.input.userbins.UserBinSource import MinimalBinSource
        from gtrackcore_compressed.extract.fileformats.FileFormatComposer import \
    ...
    def getAttrsFromExtractionFormat(cls, extractionFormat):
        ...
        if asOriginal:
            ...
            from gtrackcore_compressed.extract.fileformats.FileFormatComposer import getComposerClsFromFileSuffix
    ...
    def extract(cls, trackName, regionList, fn, fileFormatName=DEFAULT_FILE_FORMAT_NAME, globalCoords=True, \
        ...
        from gtrackcore_compressed.input.adapters.TrackGenomeElementSource import TrackGenomeElementSource
        from gtrackcore_compressed.extract.fileformats.FileFormatComposer import getComposerClsFromFileFormatName, getComposerClsFromFileSuffix
