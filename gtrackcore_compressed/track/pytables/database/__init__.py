import tables
import atexit
from gtrackcore_compressed.metadata.TrackInfo import DynamicTrackInfo
...
from gtrackcore_compressed.util.pytables.NameFunctions import get_genome_and_trackname
