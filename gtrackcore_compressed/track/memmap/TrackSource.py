...
from gtrackcore_compressed.track.memmap.CommonMemmapFunctions import parseMemmapFileFn
from gtrackcore_compressed.track.memmap.SmartMemmap import SmartMemmap
from gtrackcore_compressed.track.memmap.BoundingRegionShelve import BoundingRegionShelve, isBoundingRegionFileName
...
class TrackSource:
    ...
    def getTrackData(self, trackName, genome, chr, allowOverlaps, forceChrFolders=False):
        ...
        dir = get_dir_path(genome, trackName, chr, allowOverlaps)
