...
import gtrackcore_compressed.third_party.safeshelve as safeshelve
...
from gtrackcore_compressed.util.CustomExceptions import InvalidFormatError, OutsideBoundingRegionError, \
...
class BoundingRegionShelve(object):
    ...
    def storeBoundingRegions(self, boundingRegionTuples, genomeElementChrList, sparse):
        ...
        while not self.fileExists():
            from gtrackcore_compressed.application.LogSetup import logMessage
    ...
    def getBoundingRegionInfo(self, region):
        ...
        if region.chr in self._contents:
            ...
            if not self._minimalRegion == region:
                ...
                #
                from gtrackcore_compressed.util.CommonFunctions import prettyPrintTrackName
