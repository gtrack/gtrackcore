...
from gtrackcore_compressed.track.format.AllFormatConverters import getFormatConverters, getFormatConverterByName
from gtrackcore_compressed.track.format.TrackFormat import TrackFormatReq, NeutralTrackFormatReq, TrackFormat
...
from gtrackcore_compressed.util.CommonFunctions import getClassName, prettyPrintTrackName
from gtrackcore_compressed.util.CustomExceptions import IncompatibleTracksError
...
class Track(object):
    ...
    def _getRawTrackView(self, region, borderHandling, allowOverlaps):
        trackData = self._trackSource.get_track_data(region.genome, self.trackName, allowOverlaps)
...
class VirtualMinimalTrack(Track):
    ...
    def _getRawTrackView(self, region, borderHandling, allowOverlaps):
        ...
        from gtrackcore_compressed.track.memmap.CommonMemmapFunctions import findEmptyVal
