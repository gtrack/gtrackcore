...
#from track5.util.StaticFile import GalaxyRunSpecificFile
from track5.util.CommonFunctions import ensurePathExists
...
class Profiler:
    ...
    def printStats(self, graphDir=None, id=None):
        ...
        if graphDir:
            from track5.util.PstatsUtil import OverheadStats
            import os
