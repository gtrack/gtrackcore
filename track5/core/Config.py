...
from track5.util.CustomExceptions import ArgumentValueError
...
class Config(object):
    ...
    @classmethod
    def initialize(cls, configFileName='~/track5_config', dataDir='~/track5_data'):
        ...
        try:
            ...
            configDef['General'] = OrderedDict( \
                [('LOG_PATH', os.path.expanduser('~/track5_logs')), \
