...
from track5.util.CommonFunctions import createOrigPath, createDirPath, ensurePathExists
...
class TestWithGeSourceData(unittest.TestCase):
    ...
    def _commonSetup(self):
        from track5.test.input.core.TestGenomeElementSource import TestGenomeElementSource
