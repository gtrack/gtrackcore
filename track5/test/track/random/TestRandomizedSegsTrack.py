...
from track5.test.track.common.SampleTrack import SampleTrack
from track5.test.track.common.SampleTrackView import SampleTV, SampleTV_Num
from track5.track.core.GenomeRegion import GenomeRegion
from track5.track.core.Track import PlainTrack
from track5.track.random.PermutedSegsAndIntersegsTrack import PermutedSegsAndIntersegsTrack
from track5.track.random.PermutedSegsAndSampledIntersegsTrack import PermutedSegsAndSampledIntersegsTrack
from track5.track.random.SegsSampledByIntensityTrack import SegsSampledByIntensityTrack

import track5.track.random.SegsSampledByIntensityTrack
...
class TestRandomizedSegsTrack(TestCaseWithImprovedAsserts):
    ...
    def _doRandTest(self, origTV, randTrackClasses):
        ...
        track5.track.random.SegsSampledByIntensityTrack.PlainTrack = MyPlainTrack
