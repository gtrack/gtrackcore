...
def get_data_path():
    ...
    return pkg_resources.resource_filename('track5', 'data')
...
def setup_paths():
    ...
    track_output_path = os.path.join(data_output_path, 'track5_data')
    ...
    config_fn = os.path.join(data_output_path, 'track5_config')
