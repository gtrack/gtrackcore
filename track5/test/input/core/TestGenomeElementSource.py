...
from track5.input.fileformats.BedGenomeElementSource import BedGenomeElementSource, PointBedGenomeElementSource, \
...
from track5.input.fileformats.BedGraphGenomeElementSource import BedGraphGenomeElementSource, BedGraphTargetControlGenomeElementSource
from track5.input.fileformats.WigGenomeElementSource import WigGenomeElementSource, HbWigGenomeElementSource
from track5.input.fileformats.MicroarrayGenomeElementSource import MicroarrayGenomeElementSource
from track5.input.fileformats.GtrackGenomeElementSource import GtrackGenomeElementSource, HbGzipGtrackGenomeElementSource, \
...
from track5.util.CustomExceptions import InvalidFormatWarning, InvalidFormatError, Warning, ArgumentValueError
    ...
    def setUp(self):
        ...
        self.cases['gtrack_t27'] = \
            Case(GtrackGenomeElementSource,
                ...
                GenomeElement('TestGenome', 'chrM', start=20, id='b', edges=['a'], weights=[numpy.nan])],
                [],
                GtrackGenomeElementSource,
                ['start', 'id', 'edges', 'weights'],
                'float64',
