...
import track5.preprocess.memmap.OutputDirectory

from track5.input.core.GenomeElement import GenomeElement
from track5.preprocess.memmap.OutputFile import OutputFile
...
from track5.test.common.FileUtils import removeDirectoryTree
...
class SetupDir:
    def __init__(self, path, prefixList):
        ...
        from track5.preprocess.memmap.OutputDirectory import OutputDirectory
...
class TestOutputDirectory(TestCaseWithImprovedAsserts):
    ...
    def setUp(self):
        ...
        track5.preprocess.memmap.OutputDirectory.OutputFile = MyOutputFile
        track5.preprocess.memmap.OutputDirectory.OutputIndexFilePair = MyOutputIndexFilePair
    ...
    def tearDown(self):
        ...
        track5.preprocess.memmap.OutputDirectory.OutputFile = OutputFile
        track5.preprocess.memmap.OutputDirectory.OutputIndexFilePair = OutputIndexFilePair        
        self._removeDirTree()
