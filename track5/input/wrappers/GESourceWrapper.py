from track5.util.CustomExceptions import InvalidFormatError, ShouldNotOccurError, AbstractClassError
...
class ElementModifierGESourceWrapper(GESourceWrapper, GenomeElementSource):
    ...
    def _brtAndGeIterator(self):
        from track5.input.wrappers.GEDependentAttributesHolder import iterateOverBRTuplesWithContainedGEs
