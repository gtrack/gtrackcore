...
from track5.core.LogSetup import logException
from track5.input.core.GenomeElement import GenomeElement
from track5.metadata.GenomeInfo import GenomeInfo
from track5.util.CommonFunctions import getFileSuffix
from track5.util.CommonConstants import BINARY_MISSING_VAL, RESERVED_PREFIXES
from track5.util.CustomExceptions import NotSupportedError, InvalidFormatError, \
...
def getAllGenomeElementSourceClasses(forPreProcessor):
    from track5.input.fileformats.BedGenomeElementSource import PointBedGenomeElementSource, BedValuedGenomeElementSource, \
                                                                BedCategoryGenomeElementSource, BedGenomeElementSource
    from track5.input.fileformats.GffGenomeElementSource import GffGenomeElementSource
    from track5.input.fileformats.FastaGenomeElementSource import FastaGenomeElementSource
    from track5.input.fileformats.HBFunctionGenomeElementSource import HBFunctionGenomeElementSource
    from track5.input.fileformats.BedGraphGenomeElementSource import BedGraphTargetControlGenomeElementSource, BedGraphGenomeElementSource
    from track5.input.fileformats.MicroarrayGenomeElementSource import MicroarrayGenomeElementSource
    ...
    if forPreProcessor:
        from track5.input.fileformats.WigGenomeElementSource import HbWigGenomeElementSource
        from track5.input.fileformats.GtrackGenomeElementSource import HbGzipGtrackGenomeElementSource, HbGtrackGenomeElementSource
        allGESourceClasses += [HbWigGenomeElementSource, HbGzipGtrackGenomeElementSource, HbGtrackGenomeElementSource]
    else:
        from track5.input.fileformats.WigGenomeElementSource import WigGenomeElementSource
        from track5.input.fileformats.GtrackGenomeElementSource import GzipGtrackGenomeElementSource, GtrackGenomeElementSource
