...
from track5.preprocess.memmap.GEParseFunctions import getStart, getEnd, getStrand, getVal, getId, getEdges, \
                                                      getWeights, getNone, GetExtra, \
                                                      writeNoSlice, writeSliceFromFront
from track5.track.memmap.CommonMemmapFunctions import createMemmapFileFn, findEmptyVal, calcShapeFromMemmapFileFn
from track5.util.CommonFunctions import product
