...
from track5.util.CustomExceptions import IncompatibleTracksError, InvalidRunSpecException
...
class SegsSampledByIntensityTrack(RandomizedTrack):    
    def __init__(self, origTrack, origRegion, randIndex, trackNameIntensity="", **kwArgs):
        ...
        #from track5.util.CustomExceptions import SplittableStatNotAvailableError
