...
import track5.third_party.safeshelve as safeshelve

from track5.metadata.GenomeInfo import GenomeInfo
from track5.track.core.GenomeRegion import GenomeRegion
from track5.util.CustomExceptions import InvalidFormatError, OutsideBoundingRegionError, \
                                         BoundingRegionsNotAvailableError
from track5.util.CompBinManager import CompBinManager
...
class BoundingRegionShelve(object):
    ...
    def storeBoundingRegions(self, boundingRegionTuples, genomeElementChrList, sparse):
        ...
        while not self.fileExists():
            from track5.application.LogSetup import logMessage
    ...
    def getBoundingRegionInfo(self, region):
        ...
        if region.chr in self._contents:
            ...
            if not self._minimalRegion == region:
                ...
                #
                from track5.util.CommonFunctions import prettyPrintTrackName
