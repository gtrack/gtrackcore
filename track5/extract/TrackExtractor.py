...
from track5.track.core.Track import Track
from track5.track.format.TrackFormat import TrackFormatReq
from track5.util.CommonFunctions import getStringFromStrand, parseRegSpec, \
                                        parseTrackNameSpec, createDirPath, \
                                        ensurePathExists
from track5.util.CustomExceptions import NotSupportedError, ShouldNotOccurError
...
class TrackExtractor:
    ...
    def getTrackExtractionOptions(genome, trackName):
        from track5.track.core.Track import PlainTrack
        from track5.input.userbins.UserBinSource import MinimalBinSource
        from track5.extract.fileformats.FileFormatComposer import \
    ...
    def getAttrsFromExtractionFormat(cls, extractionFormat):
        ...
        if asOriginal:
            ...
            from track5.extract.fileformats.FileFormatComposer import getComposerClsFromFileSuffix
    ...
    def extract(cls, trackName, regionList, fn, fileFormatName=DEFAULT_FILE_FORMAT_NAME, globalCoords=True, \
        ...
        from track5.extract.fileformats.FileFormatComposer import getComposerClsFromFileFormatName, getComposerClsFromFileSuffix
