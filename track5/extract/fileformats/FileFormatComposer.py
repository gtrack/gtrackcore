...
from track5.util.CommonFunctions import isNan, ensurePathExists
from track5.util.CustomExceptions import InvalidFormatError, AbstractClassError, NotIteratedYetError
...
def getAllComposers():
    ...
    from track5.extract.fileformats.BedComposer import BedComposer, PointBedComposer, CategoryBedComposer, ValuedBedComposer
    from track5.extract.fileformats.BedGraphComposer import BedGraphComposer, BedGraphTargetControlComposer
    from track5.extract.fileformats.GffComposer import GffComposer
    from track5.extract.fileformats.WigComposer import WigComposer
    from track5.extract.fileformats.FastaComposer import FastaComposer
