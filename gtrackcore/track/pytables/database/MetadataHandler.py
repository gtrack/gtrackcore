...
class MetadataHandler(object):
    ...
    def __init__(self, genome, track_name):
        ...
        self._trackinfo_node_names = DatabaseUtils.get_trackinfo_node_names(self._genome, self._track_name)


    def store(self):
        database_filename = DatabaseUtils.get_database_filename(self._genome, self._track_name, allow_overlaps=False)
    ...
    def update_db_trackinfo(self, database_filename):
        ...
        if persisted_ti_node is not None:
            ...
            trackinfo_base_nodes = DatabaseUtils.get_base_node_names(self._genome, self._track_name)
    ...
    def _dump_dynamic_trackinfo(self, dynamic_ti, db_writer):
        ...
        ti_file = filenode.new_node(db_writer.h5_file, where=ti_group_path, name=DatabaseUtils.TRACKINFO_NODE_NAME)
