...
def get_start_and_end_indices(region, track_name, allow_overlaps, track_format):
    ...
    br_node_names = DatabaseUtils.get_br_table_node_names(track_name, allow_overlaps)
    ...
    if track_format.reprIsDense():
        ...
        track_table_node_names = DatabaseUtils.get_track_table_node_names(track_name, allow_overlaps)
