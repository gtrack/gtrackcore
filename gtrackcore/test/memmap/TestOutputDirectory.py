...
import gtrackcore.preprocess.memmap.OutputDirectory
...
from gtrackcore.test.common.FileUtils import removeDirectoryTree
...
class TestOutputDirectory(TestCaseWithImprovedAsserts):
    ...
    def setUp(self):
        ...
        gtrackcore.preprocess.memmap.OutputDirectory.OutputFile = MyOutputFile
        gtrackcore.preprocess.memmap.OutputDirectory.OutputIndexFilePair = MyOutputIndexFilePair
    ...
    def tearDown(self):
        ...
        gtrackcore.preprocess.memmap.OutputDirectory.OutputFile = OutputFile
        gtrackcore.preprocess.memmap.OutputDirectory.OutputIndexFilePair = OutputIndexFilePair        
        self._removeDirTree()
