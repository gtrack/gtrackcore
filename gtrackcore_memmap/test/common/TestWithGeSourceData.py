...
from gtrackcore_memmap.util.CommonFunctions import createOrigPath, createDirPath, ensurePathExists
...
class TestWithGeSourceData(unittest.TestCase):
    ...
    def _commonSetup(self):
        from gtrackcore_memmap.test.input.core.TestGenomeElementSource import TestGenomeElementSource
