...
import gtrackcore_memmap.util.CompBinManager

from gtrackcore_memmap.test.common.Asserts import TestCaseWithImprovedAsserts, AssertList
from gtrackcore_memmap.test.track.common.SampleTrackView import getRandValList, getRandStrandList, getRandGraphLists
from gtrackcore_memmap.track.core.GenomeRegion import GenomeRegion
from gtrackcore_memmap.track.memmap.TrackSource import TrackData

class TestTrackViewLoader(TestCaseWithImprovedAsserts):
    def setUp(self):
        self.prevCompBinSize = gtrackcore_memmap.util.CompBinManager.COMP_BIN_SIZE
        gtrackcore_memmap.util.CompBinManager.COMP_BIN_SIZE = 100

        from gtrackcore_memmap.track.memmap.TrackViewLoader import TrackViewLoader
        self.trackViewLoader = TrackViewLoader()

    def tearDown(self):
        gtrackcore_memmap.util.CompBinManager.COMP_BIN_SIZE = self.prevCompBinSize
