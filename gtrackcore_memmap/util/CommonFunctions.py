...
#from gtrackcore_memmap.application.SignatureDevianceLogging import takes,returns
#from third_party.decorator import decorator
#
...
def getFileSuffix(fn):
    from gtrackcore_memmap.core.DataTypes import getSupportedFileSuffixes
...
#    from gtrackcore_memmap.application.LogSetup import logMessage, logging
#    
...
#    #from gtrackcore_memmap.util.CommonFunctions import repackageException
