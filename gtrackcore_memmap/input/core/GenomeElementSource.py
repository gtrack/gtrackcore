...
from gtrackcore_memmap.core.LogSetup import logException
...
from gtrackcore_memmap.util.CommonFunctions import getFileSuffix
from gtrackcore_memmap.util.CommonConstants import BINARY_MISSING_VAL, RESERVED_PREFIXES
from gtrackcore_memmap.util.CustomExceptions import NotSupportedError, InvalidFormatError, \
...
def getAllGenomeElementSourceClasses(forPreProcessor):
    from gtrackcore_memmap.input.fileformats.BedGenomeElementSource import PointBedGenomeElementSource, BedValuedGenomeElementSource, \
                                                                BedCategoryGenomeElementSource, BedGenomeElementSource

    from gtrackcore_memmap.input.fileformats.GffGenomeElementSource import GffCategoryGenomeElementSource, GffGenomeElementSource
    ...
    from gtrackcore_memmap.input.fileformats.BedGraphGenomeElementSource import BedGraphTargetControlGenomeElementSource, BedGraphGenomeElementSource
    ...
    if forPreProcessor:
        from gtrackcore_memmap.input.fileformats.WigGenomeElementSource import HbWigGenomeElementSource
        from gtrackcore_memmap.input.fileformats.GtrackGenomeElementSource import HbGzipGtrackGenomeElementSource, HbGtrackGenomeElementSource
        allGESourceClasses += [HbWigGenomeElementSource, HbGzipGtrackGenomeElementSource, HbGtrackGenomeElementSource]
    else:
        from gtrackcore_memmap.input.fileformats.WigGenomeElementSource import WigGenomeElementSource
        from gtrackcore_memmap.input.fileformats.GtrackGenomeElementSource import GzipGtrackGenomeElementSource, GtrackGenomeElementSource
