...
from gtrackcore_memmap.util.CommonFunctions import getStringFromStrand, smartRecursiveEquals
    ...
    def _downloadSubtypeFileContents(cls, url):
        try:
            if url.startswith('http://gtrack.no/'):
                ...
                path = pkg_resources.resource_filename('gtrackcore_memmap', 'data')
