...
from gtrackcore_memmap.input.core.GenomeElementSource import BoundingRegionTuple, GenomeElementSource
...
class FullTrackGenomeElementSource(TrackGenomeElementSource):
    def __init__(self, genome, trackName, allowOverlaps=False, *args, **kwArgs):
        from gtrackcore_memmap.track.BoundingRegionShelve import BoundingRegionShelve
...
class TrackViewListGenomeElementSource(TrackGenomeElementSource):
    ...
    def _getTrackData(self):
        from gtrackcore_memmap.track.core.TrackView import noneFunc
