from gtrackcore_memmap.track.format.FormatConverter import TrivialFormatConverter
from gtrackcore_memmap.track.format.SegmentToPointFormatConverter import SegmentToStartPointFormatConverter, \
