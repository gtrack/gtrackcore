...
from gtrackcore_memmap.input.fileformats.GtrackGenomeElementSource import GtrackGenomeElementSource as Gtrack
from gtrackcore_memmap.track.format.TrackFormat import TrackFormat
from gtrackcore_memmap.util.CommonFunctions import getStringFromStrand, isIter, isNan
