...
from gtrackcore_memmap.util.CommonFunctions import isNan, ensurePathExists
from gtrackcore_memmap.util.CustomExceptions import InvalidFormatError, AbstractClassError, NotIteratedYetError
...
def getAllComposers():
    ...
    from gtrackcore_memmap.extract.fileformats.BedGraphComposer import BedGraphComposer, BedGraphTargetControlComposer
